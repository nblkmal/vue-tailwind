            ...
            <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" @submit.prevent="storeDepartment">
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Add new department</h3>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.description" id="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required>
                        </div>
...
export default {
    ...
    methods: {
        ...
        storeDepartment() {
            axios.post(this.route('department:store'), 
                {
                    'name': this.form.name,
